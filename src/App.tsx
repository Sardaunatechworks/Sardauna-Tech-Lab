...
const TeamCard = ({ name, role, index }: TeamMemberProps) => (
  <motion.div 
      ...
      <section id="services" className="section-padding bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard icon={Globe} title="Web Development & Design" index={0} />
            <ServiceCard icon={Layout} title="Custom Business Systems" index={1} />
            <ServiceCard icon={Cpu} title="AI & Automation Integration" index={2} />
            <ServiceCard icon={Layout} title="UI/UX Design" index={3} />
            <ServiceCard icon={MessageSquare} title="IT Consulting & Digital Strategy" index={4} />
            <ServiceCard icon={Database} title="Admin Dashboards & CRM" index={5} />
          </div>
        </div>
      </section>
      ...
      <section id="team" className="section-padding bg-slate-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <TeamCard name="Muhammad Auwal Abubakar" role="Founder/CEO" index={0} />
            <TeamCard name="Maryam Abubakar" role="Co-Founder" index={1} />
            <TeamCard name="Jibril Raji Qasim" role="Chief Technology Officer" index={2} />
            <TeamCard name="Mustapha Abdulsalam" role="Assistant CTO" index={3} />
            <TeamCard name="Hussaini Jibril" role="AI/ML Engineer" index={4} />
            <TeamCard name="Khalid Murtala" role="Developer" index={5} />
            <TeamCard name="Ibrahim Rabie Ismail" role="Business Development Manager" index={6} />
            <TeamCard name="Muhammad Mukthar" role="Product Designer" index={7} />
          </div>
        </div>
      </section>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 text-sm">info@sardaunatechlab.xyz</p>
                    <p className="text-slate-300 text-sm">contact@sardaunatechlab.xyz</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center text-brand-gold shrink-0">
